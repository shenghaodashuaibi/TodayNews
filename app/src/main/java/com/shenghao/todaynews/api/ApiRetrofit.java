...
import com.shenghao.todaynews.app.ApiConstant;
import com.shenghao.todaynews.app.MyApp;
import com.shenghao.todaynews.utils.NetWorkUtils;
...
public class ApiRetrofit {
    ...
    private Interceptor mCacheInterceptor = chain -> {
        ...
        if(!NetWorkUtils.isNetworkAvailable(MyApp.getmContext())){
    ...
    public ApiRetrofit(){
        File httpCacheDirectory = new File(MyApp.getmContext().getCacheDir(), "responses");
