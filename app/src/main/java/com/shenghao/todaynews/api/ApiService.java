...
import com.shenghao.todaynews.model.entity.NewsDetail;
import com.shenghao.todaynews.model.entity.VideoModel;
import com.shenghao.todaynews.model.response.CommentResponse;
import com.shenghao.todaynews.model.response.NewsResponse;
import com.shenghao.todaynews.model.response.ResultResponse;
import com.shenghao.todaynews.model.response.VideoPathResponse;
...
public interface ApiService {
    ...
    @Headers({"Content-Type:application/x-www-form-urlencoded; charset=UTF-8",
            "Cookie:PHPSESSIID=334267171504; _ga=GA1.2.646236375.1499951727; " +
                    "_gid=GA1.2.951962968.1507171739; Hm_lvt_e0a6a4397bcb500e807c5228d70253c8=1507174305;" +
